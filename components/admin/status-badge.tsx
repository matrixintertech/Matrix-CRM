...
const styles: Record<string, string> = {
  ...
  REVISED: "bg-cyan-50 text-cyan-700 ring-cyan-200",
  ...
  PARTIALLY_FULFILLED: "bg-indigo-50 text-indigo-700 ring-indigo-200",
  FULFILLED: "bg-emerald-50 text-emerald-700 ring-emerald-200",
  INVITED: "bg-slate-100 text-slate-700 ring-slate-200",
  YET_TO_START: "bg-slate-100 text-slate-700 ring-slate-200",
  REOPENED: "bg-cyan-50 text-cyan-700 ring-cyan-200",
